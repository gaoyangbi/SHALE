...
!
! V0.3 - with time measurement
!
! Tobias Wittwer, 2006
program shale
    implicit none
    ! settings
    integer*4, parameter :: nmax = 20                ! maximum degree/order
    integer*4, parameter :: nobs = 990                 ! number of observations
    character*80, parameter :: obsfile = 'pot_glob_0_20.txt'   ! observation file
    character*80, parameter :: outfile = 'cnm_20_ls.txt'   ! output file
